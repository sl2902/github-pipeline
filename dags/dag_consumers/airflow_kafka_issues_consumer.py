...
kafka_issues_consumer = SSHOperator(
    task_id="kafka_issues_consumer",
    ...
    /opt/spark/bin/spark-submit --master spark://spark-master:7077 --deploy-mode client /opt/spark/kafka_consumer/pyspark_consume_from_kafka.py --topic issues
    """,
    ssh_hook=SSHHook,
    dag=dag
)
