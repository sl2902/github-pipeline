...
spark_base_repo_transfer = SSHOperator(
    ...
    /opt/spark/bin/spark-submit --master spark://spark-master:7077 --deploy-mode client /opt/spark/spark_batch/pg_to_iceberg.py --table base_repo
    """,
    ssh_hook=SSHHook,
    dag=dag
)
...
spark_base_repo_transfer >> trigger_dbt_base_repo_model